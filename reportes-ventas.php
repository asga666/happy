<html>
	...
	<body>
		...
		<div id="contenedor">
			...
			<span class="title-icon typcn typcn-chart-area"></span>
			<h2 class="title-page">Reportes de ventas</h2>
			</div>
				<div class="barra">
					<p class="folio" style="margin-left: 20px; display: inline-block; margin-right: 20px;">Totales: 999</p>
					<form style="display: inline-block; margin-left: 20px;">
						<label for="fecha">Fecha: </label>
						<input name="fecha" placeholder="DD/MM/AA">
					</form>
					<form style="display: inline-block; margin-left: 20px;">
						<label for="hora">Hora: </label>
						<input name="hora" placeholder="9:99">
					</form>
					<a href="#"><p class="procesar"><span class="typcn typcn-arrow-down-thick"></span>Ver y descargar</p></a>
				</div>
				<div class="tabla">
					<table>
						<thead>
						...
						<tbody>
							<tr>
								...
								<td><a href="./misc/reportes/venta.pdf" target="_blank">XXXXXXXXXXXXXXXXXXXXXXXXXXXX</a></td>
								<td>XXXXXX</td>
								<td>99/99/99 - 9:99 PM</td>
							</tr>
							<tr>
								<td><center><input type="checkbox"></center></td>
								<td><a href="./misc/reportes/venta.pdf" target="_blank">XXXXXXXXXXXXXXXXXXXXXXXXXXXX</a></td>
